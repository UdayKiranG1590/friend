...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { email: @partner.email, frist_name: @partner.frist_name, last_name: @partner.last_name, phone: @partner.phone, twitter: @partner.twitter } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { email: @partner.email, frist_name: @partner.frist_name, last_name: @partner.last_name, phone: @partner.phone, twitter: @partner.twitter } }
